# Project 3 - *Rinstagram*

## Rinstagram Part 2

**Rinstagram** is a photo sharing app similar to Instagram but using Parse as its backend.
...
- [x] User can tap on picture in detail page for a better view
